var capacitorCapacitorApkUpdater = (function (exports, core) {
    'use strict';

    const CapacitorApkUpdater = core.registerPlugin('CapacitorApkUpdater', {
        web: () => Promise.resolve().then(function () { return web; }).then((m) => new m.CapacitorApkUpdaterWeb()),
    });

    class CapacitorApkUpdaterWeb extends core.WebPlugin {
    ...
    var web = /*#__PURE__*/Object.freeze({
        __proto__: null,
        CapacitorApkUpdaterWeb: CapacitorApkUpdaterWeb
    });

    exports.CapacitorApkUpdater = CapacitorApkUpdater;
